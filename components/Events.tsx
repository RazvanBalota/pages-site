          ...
          <div class="pb-4">
            <figure>
              <blockquote class=" leading-6 text-gray-900  sm:text-lg sm:leading-6 w-full lg:w-2/3">
                ...
                <Paragraph>
                AI3 organizează întâlniri periodice unde se discută diferite strategii de îmbunătățire/planificare a proiectelor și evenimentelor conturând rolul județului Alba în ecosistemul tehnologic al regiunii.
                </Paragraph>     
              </blockquote>
            </figure>
          </div>
          ...
          <div class="pb-4">
            <figure>
                <blockquote class=" leading-6 text-gray-900 sm:text-lg sm:leading-6 w-full lg:w-2/3">
                    ...
                    <Paragraph>
                      AI3 te invită să explorezi primul Festival Digital din județul Alba unde trecutul longeviv întâlnește manifestarea artistică digitală în cel mai important oraș istoric din România: Alba Iulia, Cealaltă Capitală.
                    </Paragraph>
                </blockquote>
            </figure>
          </div>
              ...
              <div>
                <blockquote>
                    ...
                    <div>
                        ...
                        <a href="https://www.facebook.com/coderdojoalbaiulia/" class="text-base leading-6 tracking-tight lg:text-lg text-blue-500 hover:text-blue-600 transition">facebook</a>
                        </Paragraph>
                    </div>
                </blockquote>
              </div>
